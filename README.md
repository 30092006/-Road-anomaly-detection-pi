...
Real-time AI-based road anomaly and obstacle detection system using Raspberry Pi. The system detects potholes, pedestrians, animals, shops, and other road obstacles from dashcam footage with approximately 80% accuracy to improve road safety and smart transportation monitoring.
